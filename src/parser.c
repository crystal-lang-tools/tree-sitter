...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (('2' <= lookahead && lookahead <= '7')) ADVANCE(58);
      if (lookahead != 0 &&
          lookahead > '`' &&
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(182)] = 2930,
  [SMALL_STATE(183)] = 2937,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [25] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__statements, 1),
  [27] = {.entry = {.count = 1, .reusable = false}}, SHIFT(120),
  [29] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__statements_repeat1, 2),
  [33] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__statements_repeat1, 2), SHIFT_REPEAT(178),
  [36] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__statements_repeat1, 2), SHIFT_REPEAT(3),
  [39] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__statements_repeat1, 2), SHIFT_REPEAT(146),
  [42] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__statements_repeat1, 2), SHIFT_REPEAT(97),
  [45] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__statements_repeat1, 2), SHIFT_REPEAT(6),
  [48] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__statements_repeat1, 2), SHIFT_REPEAT(32),
  [51] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__statements_repeat1, 2), SHIFT_REPEAT(24),
  [54] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__statements_repeat1, 2), SHIFT_REPEAT(17),
  [57] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__statements_repeat1, 2), SHIFT_REPEAT(44),
  [60] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__statements_repeat1, 2), SHIFT_REPEAT(47),
  ...
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_integer_repeat1, 2),
  [95] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_integer_repeat1, 2),
  [97] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_integer_repeat1, 2), SHIFT_REPEAT(8),
  [100] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_integer_repeat1, 2), SHIFT_REPEAT(9),
  [103] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_integer_repeat1, 2), SHIFT_REPEAT(10),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_integer_repeat2, 2),
  [108] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_integer_repeat2, 2),
  [110] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_integer_repeat2, 2), SHIFT_REPEAT(11),
  ...
  [119] = {.entry = {.count = 1, .reusable = false}}, SHIFT(143),
  ...
  [135] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_integer_repeat2, 2), SHIFT_REPEAT(16),
  ...
  [154] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_integer_repeat2, 2), SHIFT_REPEAT(21),
  ...
  [175] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__statements_repeat1, 2),
  ...
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_integer_repeat3, 2),
  [191] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_integer_repeat3, 2),
  [193] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_integer_repeat3, 2), SHIFT_REPEAT(33),
  [196] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_integer_repeat4, 2),
  [198] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_integer_repeat4, 2),
  [200] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_integer_repeat4, 2), SHIFT_REPEAT(34),
  [203] = {.entry = {.count = 1, .reusable = false}}, SHIFT(26),
  [205] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_integer_repeat3, 2), SHIFT_REPEAT(36),
  ...
  [216] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_integer_repeat4, 2), SHIFT_REPEAT(41),
  ...
  [225] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_integer_repeat4, 2), SHIFT_REPEAT(45),
  [228] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_integer_repeat3, 2), SHIFT_REPEAT(46),
  ...
  [271] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_chained_string_repeat1, 2), SHIFT_REPEAT(171),
  [274] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_chained_string_repeat1, 2), SHIFT_REPEAT(91),
  ...
  [297] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_chained_string_repeat1, 2), SHIFT_REPEAT(146),
  [300] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_chained_string_repeat1, 2), SHIFT_REPEAT(97),
  [303] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_float, 8),
  [305] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_float, 8),
  ...
  [315] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_float, 5),
  [317] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_float, 5),
  ...
  [337] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_float, 6),
  [339] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_float, 6),
  [341] = {.entry = {.count = 1, .reusable = false}}, SHIFT(152),
  [343] = {.entry = {.count = 1, .reusable = false}}, SHIFT(74),
  [345] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_percent_string_repeat1, 2),
  [347] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_percent_string_repeat1, 2), SHIFT_REPEAT(73),
  ...
  [374] = {.entry = {.count = 1, .reusable = false}}, SHIFT(182),
